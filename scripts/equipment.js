$(document).ready(function () {
    ...
    function loadFields() {
        $.ajax({
            ...
            success: function (response) {
                const fieldDropdown = $("#editFieldCode");
                fieldDropdown.empty();
                response.forEach(field => {
                    fieldDropdown.append(new Option(field.fieldCode, field.fieldCode));
                });
            },
    ...
    function loadStaffMembers() {
        $.ajax({
            ...
            method: "GET",
            success: function (response) {
                const staffDropdown = $("#editStaffMemberId");
                staffDropdown.empty();
                response.forEach(staff => {
                    staffDropdown.append(new Option(staff.staffMemberId, staff.staffMemberId));
                });
            },
            error: function (xhr, status, error) {
    ...
    $("#editEquipmentForm").submit(function (event) {
        ...
        $.ajax({
            ...
            success: function () {
                ...
                loadEquipments(); // Refresh the equipment list
